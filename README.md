...
local WelcomeFrame = Instance.new("Frame") -- Cria o quadro de boas-vindas
local WelcomeText = Instance.new("TextLabel") -- Texto de boas-vindas
local FarmGui = Instance.new("Frame") -- Guia de farm

-- Configuração inicial da interface principal
ScreenGui.Parent = game.CoreGui
ScreenGui.Name = "BloxFruitsHub"

-- Configuração do quadro de boas-vindas
WelcomeFrame.Parent = ScreenGui
WelcomeFrame.Size = UDim2.new(0.4, 0, 0.2, 0)
WelcomeFrame.Position = UDim2.new(0.3, 0, 0.4, 0)
...
local UICorner = Instance.new("UICorner", WelcomeFrame)
...
WelcomeText.Text = "Olá, " .. Player.Name .. "!"
...
spawn(function()
    while WelcomeFrame.Visible do
        WelcomeFrame.BackgroundColor3 = Color3.fromRGB(math.random(0, 255), math.random(0, 255), math.random(0, 255))
        wait(0.2)
    end
end)

-- Configuração da guia de farm (inicialmente oculta)
FarmGui.Parent = ScreenGui
FarmGui.Size = UDim2.new(0.5, 0, 0.6, 0)
FarmGui.Position = UDim2.new(0.25, 0, 0.2, 0)
FarmGui.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
FarmGui.BorderSizePixel = 0
FarmGui.Visible = false

local FarmUICorner = Instance.new("UICorner", FarmGui)
FarmUICorner.CornerRadius = UDim.new(0.1, 0)

local FarmText = Instance.new("TextLabel") -- Texto dentro da guia de farm
FarmText.Parent = FarmGui
FarmText.Size = UDim2.new(1, 0, 0.2, 0)
FarmText.BackgroundTransparency = 1
FarmText.Text = "Farm Automático Ativado!"
FarmText.Font = Enum.Font.GothamBold
FarmText.TextSize = 20
FarmText.TextColor3 = Color3.fromRGB(255, 255, 255)
FarmText.TextScaled = true

-- Função para alternar entre a saudação e a guia de farm
wait(4) -- Aguarda 4 segundos

-- Animação de fechamento
for i = 1, 10 do
    WelcomeFrame.BackgroundTransparency = WelcomeFrame.BackgroundTransparency + 0.1
    WelcomeFrame.Size = WelcomeFrame.Size - UDim2.new(0.02, 0, 0.02, 0)
    wait(0.05)
end
